...
import os # Week 14 - Task 0 - Step 4 configure static files and templates, import os prplxty
...
SECRET_KEY = 'django-insecure-*bp38o*bz(wqw(1l1hcu5rk7xmo@o&$iw%e$zi43r&nbylxt8!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates' 'blog/templates'] # Add templates directory Week 14 - Task 0 - Step 4 configure static files and templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Week 14 -Task 0 - Step 2 - Configured the Database for PostgreSQL

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', 'django.db.backends.postgresql',
        'NAME': BASE_DIR / 'db.sqlite3', 'django_blog'
        'USER': 'yourusername',
